...
data(football, theme_elements, lesmis,madmen, mm_directed, email,
     bikes)
...
# source code for geom_net
ggplot(data = blood$edges, aes(from_id = from, to_id = to)) +
  geom_net(colour="darkred", layout="circle", label=TRUE, size=15,
           directed=TRUE, vjust=0.5, labelcolour="grey80", curvature=0,
...
# source code for ggnet2
library(GGally) # use developmental version on github for now
