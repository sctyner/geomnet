...
ggplot(data = lesmis$edges, aes(from_id = from, to_id = to, esize = value)) + geom_net(vertices = lesmis$vertices, ealpha = 2/10, layout = 'fruchtermanreingold', vlabel=TRUE) + expand_limits(x = c(0,1.1), y = c(0,1)) + theme_net
@
\begin{figure}
\centering
