...
ggplot(data = blood$edges, aes(from_id = from, to_id = to)) +
  ...
  expand_limits(x = c(0,1), y = c(0,1)) + theme_net #add vlabel & direction later
@
\sct{
